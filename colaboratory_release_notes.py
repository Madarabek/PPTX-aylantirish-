...
def pptx_to_pdf(input_path, output_path):
    ...
    print(f"Fayl muvaffaqiyatli PDF formatiga o'girildi: {output_path}")


if __name__ == "__main__":
    input_file = r"faylning_to'liq_yo'li\example.pptx"
    output_file = r"faylning_to'liq_yo'li\example.pdf"
